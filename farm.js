...
cropArray.forEach(crop => {
    ...
    cropIMG.addEventListener("mouseover",(e)=>{
        ...
        priceText.style.top = e.pageY - 250 + 'px';
        priceText.style.left = e.pageX - 350 + 'px';
...
soilArray.forEach(soil => {
    ...
    soilIMG.src = soil.img;
    soilIMG.classList.add("shop-item");
    soilShop.appendChild(soilIMG);
    const priceText = document.createElement("p");
    priceText.classList.add("price-text");
    soilIMG.addEventListener("mouseover",(e)=>{
        soilIMG.style.border = "solid darkslategray 2px";
        priceText.innerHTML = "Monster Coins: " + soil.price;
        priceText.style.top = e.pageY - 250 + 'px';
        priceText.style.left = e.pageX - 350 + 'px';
        soilShop.appendChild(priceText);
    });
    soilIMG.addEventListener("mouseleave",()=>{
        soilIMG.style.border = "solid darkslategray 1px";
        soilShop.removeChild(priceText);
    });
    soilIMG.addEventListener("click",()=>{
